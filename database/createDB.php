...
class CreateDB
{
	...
	*/
	public function create(){
		...
		$createOrganizador = "create table organizador( id int primary key auto_increment, usuario int,evento int, assinaturaImg varchar(100), foreign key (usuario) references usuario(id), foreign key (evento) references evento(id) );";
		...
		if(isset($this->con)){
			try{
				$this->con->beginTransaction();
					...
					$this->con->exec($createOrganizador);
